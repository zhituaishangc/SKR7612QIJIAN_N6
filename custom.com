...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR1=(I/*1=$85345,4=$85348//$85387,,,/WR2/"panel_blank_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/335,10,60/);修整器X_Z,修整器,生成文件用
	DEF VAR2=(I/*0=$85380,1=$85381,2=$85382/0/$85388,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[4]"/0,0,0/440,10,60/);修整轮类型:单滚轮,修整轮类型,生成文件用
	
	DEF VAR3=(I/*0=$85383,1=$85384,2=$85385/2/$85389,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[5]"/0,0,0/335,30,60/);齿形
	...
	DEF GLBJ=(R/0,50//$85321,$85321,,$85043/WR2/"panel_12_2_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[5]"/90,250,110/200,250,110/);单滚轮圆弧半径
	...
	CHANGE(VAR30)
		CALL("UP5")
		IF VAR4.VAL==1;根据接触位置计算砂轮直径
			IF VAR1.VAL==4
				VAR14.VAL=(-VAR30.VAL-VAR34.VAL/2+VAR32.VAL-DANG_QIAN_JIE_CHU.VAL)*2
			ELSE
				VAR14.VAL=(-VAR30.VAL-VAR34.VAL/2-DANG_QIAN_JIE_CHU.VAL)*2
			ENDIF
		ENDIF
	END_CHANGE
	CHANGE(VAR32)
...
//M(Mask9/$85385/"panel_9_1_chs.png"/)
	DEF VAR9=(R/0,50//$85438,$85438,,$85043/WR2/"panel_9_6_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[10]"/350,120,125/470,120,110/);当前左滚道
	DEF VAR10=(R/0,50//$85439,$85439,,$85043/WR2/"panel_9_7_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[11]"/350,140,125/470,140,110/);当前右滚道
	
    DEF VAR31=(R///$85453,$85453,,$85043/WR2/"panel_9_11_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[13]"/320,270,150/470,270,110/);当前左滚道水平偏心
	DEF VAR32=(R///$85454,$85454,,$85043/WR2/"panel_9_10_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[14]"/320,290,150/470,290,110/);当前右滚道水平偏心
	DEF VAR33=(R///$85455,$85455,,$85043/WR2/"panel_9_13_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[15]"/320,310,150/470,310,110/);当前左滚道垂直偏心
	DEF VAR34=(R///$85456,$85456,,$85043/WR2/"panel_9_12_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[16]"/320,330,150/470,330,110/);当前右滚道垂直偏心
